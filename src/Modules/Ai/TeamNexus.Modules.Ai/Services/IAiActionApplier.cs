...
/// <summary>Resolved scope of one AI action, produced by the service (board + workspace + acting user).</summary>
public sealed record AiActionContext(Guid BoardId, Guid WorkspaceId, Guid ActingUserId);

/// <summary>What an applier actually wrote — persisted into <c>applied_snapshot</c> and used by Undo.</summary>

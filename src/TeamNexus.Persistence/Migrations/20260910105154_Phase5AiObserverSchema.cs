...
{
    /// <inheritdoc />
    public partial class Phase5AiObserverSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_activity_logs_boards_board_id",
                        column: x => x.board_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_ai_observer_runs", x => x.id);
                    table.CheckConstraint("ck_ai_observer_runs_status", "\"status\" IN ('Running', 'Completed', 'Skipped', 'Failed')");
                    table.ForeignKey(
                        name: "fk_ai_observer_runs_workspaces_workspace_id",
                        column: x => x.workspace_id,
                        principalTable: "workspaces",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_ai_observer_runs_workspace_id",
                table: "ai_observer_runs",
                column: "workspace_id");

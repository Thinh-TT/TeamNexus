...
namespace TeamNexus.Persistence.Migrations
{
    ...
    [Migration("20260910105154_Phase5AiObserverSchema")]
    partial class Phase5AiObserverSchema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeamNexus.Persistence.Data.Entities.ActivityLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("TeamNexus.Persistence.Data.Entities.AiObserverRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_ai_observer_runs");

                    b.HasIndex("WorkspaceId")
                        .HasDatabaseName("ix_ai_observer_runs_workspace_id");

                    b.ToTable("ai_observer_runs", null, t =>
                        {
                            t.HasCheckConstraint("ck_ai_observer_runs_status", "\"status\" IN ('Running', 'Completed', 'Skipped', 'Failed')");
                        });
                });
            ...
            modelBuilder.Entity("TeamNexus.Persistence.Data.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("TeamNexus.Persistence.Data.Entities.ActivityLog", b =>
                {
                    b.HasOne("TeamNexus.Persistence.Data.Entities.Board", null)
                        ...
                        .HasConstraintName("fk_activity_logs_boards_board_id");
            ...
            modelBuilder.Entity("TeamNexus.Persistence.Data.Entities.AiObserverRun", b =>
                {
                    b.HasOne("TeamNexus.Persistence.Data.Entities.Workspace", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_ai_observer_runs_workspaces_workspace_id");
                });
            ...
            modelBuilder.Entity("TeamNexus.Persistence.Data.Entities.Notification", b =>
                {
                    b.HasOne("TeamNexus.Persistence.Data.Entities.ApplicationUser", "RecipientUser")
                        .WithMany()
